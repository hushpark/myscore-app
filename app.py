...
st.markdown("""
    <style>
        ...
        /* 💡 [교정 핵심 1]: 과목 활성화 블루 버튼 색상 완전 박음질 */
        ...
        /* 💡 [교정 핵심 2]: 시스템 테마 간섭을 무조건 무력화하고 강제로 새빨간 색상을 때려 넣는 절대 고유 규칙 */
