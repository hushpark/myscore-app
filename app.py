...
# =========================================================================
# 🔄 [최종 무결점 마스터 CSS] Streamlit 내부 컨테이너 정밀 타격 및 강제 고정
# =========================================================================
st.markdown("""
    <style>
        /* 1. 배경 및 사이드바 기본 격리 */
...
# =========================================================================
# 🔓 [1단계] 클린 통합 로그인 시스템 (동적 텍스트 교정 및 상시 노출)
# =========================================================================
...
# =========================================================================
    ...
    col_st_info, col_st_logout = st.columns([5, 1])
    with col_st_info: st.write(f"👤 접속 이메일: **{st.session_state['logged_student_id']}**")
    with col_st_logout:
